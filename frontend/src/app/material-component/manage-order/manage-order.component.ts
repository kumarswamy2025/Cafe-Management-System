...
export class ManageOrderComponent implements OnInit {
  ...
  getProductsByCategory(value: any) {
    this.productService.getProductsByCategoryId(value.id).subscribe(
      (resp: any) => {
        this.products = resp.SuccessData;
        this.manageOrderForm.controls.controls.setValue('');
  ...
  getProductDetails(value: any) {
    this.productService.getProductsByProductId(value.id).subscribe(
      (resp: any) => {
        // console.log("get product details",resp);
        // console.log("get product details",resp.successData[0].price);

        
        this.price = resp.successData[0].price;
        this.manageOrderForm.controls.price.setValue(resp.successData[0].price);
  ...
  submitAction() {
    ...
    this.billService.generateBillPDF(data).subscribe(
      (resp: any) => {
